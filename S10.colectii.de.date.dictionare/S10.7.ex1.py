...
# Construiti un dict in mod dinamic, cheile sunt cuvintele iar numarul este nr de aparatitii
...
for i in words: #i este cheia pe rand  #daca puneam set elimina dublicatele
    if i not in d1: # merge si fara linia asta, dar daca o scriem creste performanta adica timpul de rezolvare
        d1[i] = words.count(i)
